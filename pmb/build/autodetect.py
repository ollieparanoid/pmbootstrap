...
def arch(args, apkbuild, arch, strict=False):
    ...
    if arch:
        if "all" not in apkbuild["arch"] and arch not in apkbuild["arch"]:
            raise RuntimeError("Architecture '" + arch + "' is not supported"
